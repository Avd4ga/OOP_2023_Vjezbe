...
public class Start {
    public static void main(String[] args) {
        ...
        Optional<Book> availableBook = libraryCatalog.getAvailability("1984");
        System.out.println("Is '1984' available? " + availableBook.isPresent());

        Optional<Book> firstAvailableByAuthor = libraryCatalog.firstAvailableByAuthor("J.D. Salinger");
        System.out.println("First available book by J.D. Salinger: " + firstAvailableByAuthor.orElse(null));

        libraryCatalog.updateAvailable("To Kill a Mockingbird", true);
